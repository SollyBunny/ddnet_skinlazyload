...
MACRO_CONFIG_STR(ClLocationMsg, cl_location_msg, 128, "", CFGFLAG_CLIENT | CFGFLAG_SAVE, "The message for the location keybind")
...
MACRO_CONFIG_INT(CLHammerSpinny, cl_spinny_hammer, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Allow your hammer to spin like every other waepon")
