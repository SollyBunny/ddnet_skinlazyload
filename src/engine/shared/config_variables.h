...
MACRO_CONFIG_INT(SvTickSpeedMultiplier, sv_tick_speed_multiplier, 100, 1, 10000, CFGFLAG_SERVER, "Multiply tick speed by percentage (speed up or slow down game).")
