...
MACRO_TUNING_PARAM(GroundControlAccel, ground_control_accel, 2.0f, "Acceleration speed on the ground")
...
MACRO_TUNING_PARAM(AirControlSpeed, air_control_speed, 5.0f, "Max speed the tee can get in the air")
